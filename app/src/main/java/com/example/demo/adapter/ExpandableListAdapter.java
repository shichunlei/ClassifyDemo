...
public class ExpandableListAdapter extends BaseExpandableListAdapter {
    ...
    public View getGroupView(int groupPosition, boolean isExpanded, View convertView,
            ViewGroup parent) {
        convertView = LinearLayout.inflate(context, R.layout.item_group_layout, null);

        ImageView group_icon  = convertView.findViewById(R.id.img_icon);
        ...
        group_icon.setImageResource(
                Integer.parseInt(list.get(groupPosition).get("img").toString()));
    ...
    public View getChildView(int groupPosition, int childPosition, boolean isLastChild,
        ...
        convertView = RelativeLayout.inflate(context, R.layout.item_child_layout, null);
