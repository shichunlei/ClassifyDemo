...
public class GridTextAdapter extends BaseAdapter {
    ...
    private List<String> child_text_array = new ArrayList<>();
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = LayoutInflater.from(mContext).inflate(R.layout.item_gridview_txt, null);
            viewHodler = new ViewHodler();
            viewHodler.mTvType = convertView.findViewById(R.id.tv_item_goods_type);
